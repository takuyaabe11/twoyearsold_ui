...
class L10n {
  ...
  static const Map<String, Map<String, String>> _data = {
    ...
    'ja': {
      ...
      'difficulty': '難易度', 'easy': 'やさしい', 'medium': 'ふつう', 'hard': 'むずかしい',
    ...
    'zh_Hant': {
      ...
      'difficulty': '難度', 'easy': '簡單', 'medium': '中等', 'hard': '困難',
    ...
    'it': {
      ...
      'difficulty': 'Difficoltà', 'easy': 'Facile', 'medium': 'Medio', 'hard': 'Difficile',
    ...
    'id': {
      ...
      'difficulty': 'Kesulitan', 'easy': 'Mudah', 'medium': 'Sedang', 'hard': 'Sulit',
    ...
    'nl': {
      ...
      'difficulty': 'Moeilijkheid', 'easy': 'Makkelijk', 'medium': 'Gemiddeld', 'hard': 'Moeilijk',
    ...
    'pl': {
      ...
      'difficulty': 'Trudność', 'easy': 'Łatwy', 'medium': 'Średni', 'hard': 'Trudny',
    ...
    'th': {
      ...
      'difficulty': 'ความยาก', 'easy': 'ง่าย', 'medium': 'ปานกลาง', 'hard': 'ยาก',
    ...
    'vi': {
      ...
      'difficulty': 'Độ khó', 'easy': 'Dễ', 'medium': 'Trung bình', 'hard': 'Khó',
